...
export const CollectionsPage = ({
  ...
  return (
    <div className='fixed top-0 bottom-0 left-0 z-50 w-full h-full px-5 pt-5 overflow-y-auto bg-white'>
      ...
      <ul className='flex flex-col px-2 mt-5'>
        {navLinks.map((item, index) => (
          <li
            key={index}
            className='font-medium border-b border-solid border-neutral-100 text-neutral-800'
          >
            {item.collapsible ? (
              <Accordion>
