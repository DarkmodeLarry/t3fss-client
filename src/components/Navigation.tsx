...
const RootWrapper = tw.div`fixed hidden lg:inline-block top-2 left-1/2 -translate-x-1/2 z-20 flex items-center justify-center`
    ...
    <RootWrapper>
      <NavigationPrimitive.Root>
        <NavigationPrimitive.Item>
          <NavigationPrimitive.NextLink href='/'>
            Home
          </NavigationPrimitive.NextLink>
        </NavigationPrimitive.Item>
        <NavigationPrimitive.Item>
          <NavigationPrimitive.NextLink href='/components'>
            Components
          </NavigationPrimitive.NextLink>
        </NavigationPrimitive.Item>
        <NavigationPrimitive.Item>
